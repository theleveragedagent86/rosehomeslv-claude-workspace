# Cowork Prompt — Build The Bluffs II at Lake Las Vegas Smart Plans in Lofty
...
The 3 plans are: **The Bluffs II at Lake Las Vegas - Hot**, **The Bluffs II at Lake Las Vegas - Warm**, **The Bluffs II at Lake Las Vegas - Nurture**. They share Day 0 actions and a Day 35 handoff to "Long Term Nurture - Buyer", but the per-track touches differ as specified in the smart plan blueprint.
...
- The smart plan content file is at: `/Users/ryanrose/Downloads/Claude/New-Construction/bluffs-ii/smart-plan.md`
...
2. Create the tag: `bluffs-ii` (lowercase, exact spelling)
...
- `/Users/ryanrose/Downloads/Claude/New-Construction/bluffs-ii/smart-plan.md`
...
## Step 4: Build Plan 1 — `The Bluffs II at Lake Las Vegas - Hot`

1. Click **+ New Plan** (or **Create New Plan**)
2. Set the Plan Name: `The Bluffs II at Lake Las Vegas - Hot`
3. Trigger: **Tag Applied → `bluffs-ii`** (only fires when lead also qualifies as Hot — manual track sort by Ryan, OR automatic if Lofty supports trigger conditions)
...
## Step 5: Build Plan 2 — `The Bluffs II at Lake Las Vegas - Warm`

Repeat Step 4 for the Warm track:
- Plan Name: `The Bluffs II at Lake Las Vegas - Warm`
- Trigger: **Tag Applied → `bluffs-ii`** (default for landing-page leads)
- Same Stop-on-Reply, sender, and business-hours settings
- Add only the touches in `smart-plan.md` marked for the Warm track (skip the Day 0 30-minute Hot-only call task)
...
## Step 6: Build Plan 3 — `The Bluffs II at Lake Las Vegas - Nurture`

Repeat Step 4 for the Nurture track:
- Plan Name: `The Bluffs II at Lake Las Vegas - Nurture`
- Trigger: **Tag Applied → `bluffs-ii`** (browsing leads)
- Same settings
- Add only the touches marked for Nurture (skip the Day 0 Hot-only call task AND the Day 1 voicemail task)
- Day 0 lead email gets the DO/BBRA PDF attached
- Builder notification email goes to ryan@rosehomeslv.com
...
1. Confirm the tag `bluffs-ii` is wired to all 3 plans
...
Write a build log to `/Users/ryanrose/Downloads/Claude/New-Construction/bluffs-ii/cowork-build-log.md` with:
