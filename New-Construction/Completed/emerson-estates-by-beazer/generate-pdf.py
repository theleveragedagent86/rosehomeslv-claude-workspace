...
FOOTER_TEMPLATE = '<div style="width:100%;text-align:center;padding:8px 0;font-family:Bebas Neue,sans-serif;font-size:12px;letter-spacing:2px;color:#A7122A;"><span class="pageNumber"></span></div>'
...
async def generate_pdf():
    ...
    try:
        async with websockets.connect(ws_url, max_size=50 * 1024 * 1024) as ws:
            ...
            # Extra wait so Beazer CDN-hosted floor plan images finish loading
