# Cowork Prompt - Build Rainbow Crossing Luxury Smart Plans in Lofty
...
The 3 plans are: **Rainbow Crossing Luxury - Hot**, **Rainbow Crossing Luxury - Warm**, **Rainbow Crossing Luxury - Nurture**. They share Day 0 actions and a Day 35 handoff to "Long Term Nurture - Buyer", but the per-track touches differ as specified in the smart plan blueprint.
...
- The smart plan content file is at: `/Users/ryanrose/Downloads/Claude/New-Construction/rainbow-crossing-luxury/smart-plan.md`
...
2. Create the tag: `rainbow-crossing-luxury` (lowercase, exact spelling)
...
- `/Users/ryanrose/Downloads/Claude/New-Construction/rainbow-crossing-luxury/smart-plan.md`

The file contains all 3 tracks (Hot, Warm, Nurture) with every touch numbered, the delay, the action type (Email / Text / Call Task / Voicemail Task / Trigger Plan), the subject line (for emails), the body copy, and which tracks each touch applies to.

---

## Step 4: Build Plan 1 - `Rainbow Crossing Luxury - Hot`

1. Click **+ New Plan** (or **Create New Plan**)
2. Set the Plan Name: `Rainbow Crossing Luxury - Hot`
3. Trigger: **Tag Applied → `rainbow-crossing-luxury`** (only fires when lead also qualifies as Hot - manual track sort by Ryan, OR automatic if Lofty supports trigger conditions)
...
## Step 5: Build Plan 2 - `Rainbow Crossing Luxury - Warm`

Repeat Step 4 for the Warm track:
- Plan Name: `Rainbow Crossing Luxury - Warm`
- Trigger: **Tag Applied → `rainbow-crossing-luxury`** (default for landing-page leads)
...
## Step 6: Build Plan 3 - `Rainbow Crossing Luxury - Nurture`

Repeat Step 4 for the Nurture track:
- Plan Name: `Rainbow Crossing Luxury - Nurture`
- Trigger: **Tag Applied → `rainbow-crossing-luxury`** (browsing leads)
- Same settings
...
1. Confirm the tag `rainbow-crossing-luxury` is wired to all 3 plans
...
Write a build log to `/Users/ryanrose/Downloads/Claude/New-Construction/rainbow-crossing-luxury/cowork-build-log.md` with:
