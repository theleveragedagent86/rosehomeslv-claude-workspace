...
# Footer template: page number centered, Bebas Neue, Pulte Astronaut Blue
FOOTER_TEMPLATE = '<div style="width:100%;text-align:center;padding:8px 0;font-family:Bebas Neue,sans-serif;font-size:12px;letter-spacing:2px;color:#033764;"><span class="pageNumber"></span></div>'
