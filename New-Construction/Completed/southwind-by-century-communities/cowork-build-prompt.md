# Cowork Prompt — Build Southwind by Century Communities Smart Plans in Lofty
...
The 3 plans are: **Southwind by Century Communities - Hot**, **Southwind by Century Communities - Warm**, **Southwind by Century Communities - Nurture**. They share Day 0 actions and a Day 35 handoff to "Long Term Nurture - Buyer", but the per-track touches differ as specified in the smart plan blueprint.
...
- The smart plan content file is at: `/Users/ryanrose/Downloads/Claude/New-Construction/southwind-by-century-communities/smart-plan.md`
...
2. Create the tag: `southwind-by-century-communities` (lowercase, exact spelling)
...
- `/Users/ryanrose/Downloads/Claude/New-Construction/southwind-by-century-communities/smart-plan.md`
...
## Step 4: Build Plan 1 — `Southwind by Century Communities - Hot`

1. Click **+ New Plan** (or **Create New Plan**)
2. Set the Plan Name: `Southwind by Century Communities - Hot`
3. Trigger: **Tag Applied → `southwind-by-century-communities`** (only fires when lead also qualifies as Hot — manual track sort by Ryan, OR automatic if Lofty supports trigger conditions)
...
- Pick the action type:
  ...
  - **Create Task** (Voicemail) for Voicemail Task touches
...
- For the Day 0 lead email: **attach** the DO/BBRA PDF from `/Users/ryanrose/Downloads/Claude/New-Construction/DO.BBRA - Template/Duties Owed and BBRA.pdf`
...
## Step 5: Build Plan 2 — `Southwind by Century Communities - Warm`

Repeat Step 4 for the Warm track:
- Plan Name: `Southwind by Century Communities - Warm`
- Trigger: **Tag Applied → `southwind-by-century-communities`** (default for landing-page leads)
...
## Step 6: Build Plan 3 — `Southwind by Century Communities - Nurture`

Repeat Step 4 for the Nurture track:
- Plan Name: `Southwind by Century Communities - Nurture`
- Trigger: **Tag Applied → `southwind-by-century-communities`** (browsing leads)
- Same settings
...
1. Confirm the tag `southwind-by-century-communities` is wired to all 3 plans
...
Write a build log to `/Users/ryanrose/Downloads/Claude/New-Construction/southwind-by-century-communities/cowork-build-log.md` with:
- Total steps created per plan vs expected (Hot 17 / Warm 16 / Nurture 15, total 48 steps across all 3 plans)
...
The content uses `#lead_first_name#`. If Lofty's editor shows a visual chip / "Insert Merge Field" button, use that native method and replace every raw `#lead_first_name#` in the body with the visual chip.
