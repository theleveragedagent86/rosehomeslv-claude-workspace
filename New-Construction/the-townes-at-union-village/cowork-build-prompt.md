# Cowork Prompt — Build The Townes at Union Village Smart Plans in Lofty
...
The 3 plans are: **The Townes at Union Village - Hot**, **The Townes at Union Village - Warm**, **The Townes at Union Village - Nurture**. They share Day 0 actions and a Day 35 handoff to "Long Term Nurture - Buyer", but the per-track touches differ as specified in the smart plan blueprint.
...
- The smart plan content file is at: `/Users/ryanrose/Downloads/Claude/New-Construction/the-townes-at-union-village/smart-plan.md`
...
2. Create the tag: `the-townes-at-union-village` (lowercase, exact spelling)
...
- `/Users/ryanrose/Downloads/Claude/New-Construction/the-townes-at-union-village/smart-plan.md`
...
## Step 4: Build Plan 1 — `The Townes at Union Village - Hot`

1. Click **+ New Plan** (or **Create New Plan**)
2. Set the Plan Name: `The Townes at Union Village - Hot`
3. Trigger: **Tag Applied → `the-townes-at-union-village`** (only fires when lead also qualifies as Hot — manual track sort by Ryan, OR automatic if Lofty supports trigger conditions)
...
## Step 5: Build Plan 2 — `The Townes at Union Village - Warm`

Repeat Step 4 for the Warm track:
- Plan Name: `The Townes at Union Village - Warm`
- Trigger: **Tag Applied → `the-townes-at-union-village`** (default for landing-page leads)
- Same Stop-on-Reply, sender, and business-hours settings
- Add only the touches in `smart-plan.md` marked for the Warm track (skip the Hot-only Day 0 call task)
...
## Step 6: Build Plan 3 — `The Townes at Union Village - Nurture`

Repeat Step 4 for the Nurture track:
- Plan Name: `The Townes at Union Village - Nurture`
- Trigger: **Tag Applied → `the-townes-at-union-village`** (browsing leads)
- Same settings
- Add only the touches marked for Nurture (skip the Hot-only Day 0 call task AND the Hot+Warm Day 1 voicemail task)
- Day 0 lead email gets the DO/BBRA PDF attached
- Builder notification email goes to ryan@rosehomeslv.com
...
1. Confirm the tag `the-townes-at-union-village` is wired to all 3 plans
...
Write a build log to `/Users/ryanrose/Downloads/Claude/New-Construction/the-townes-at-union-village/cowork-build-log.md` with:
