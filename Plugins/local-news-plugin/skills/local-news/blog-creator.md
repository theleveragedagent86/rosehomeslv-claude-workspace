...
<body>
    <article>
        <h1>[Blog Title]</h1>
        <!-- NO dateline or byline here. Content starts immediately. -->
        [All content sections as described above]
    </article>
...
Where `[NN]` is the story number (01-20, zero-padded) and `[slug]` is from the SEO package.
