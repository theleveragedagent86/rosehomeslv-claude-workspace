...
### Column Details
- **#**: Story rank (1-20, matching viral strategist ranking)
- **Category**: "Gov-Dev", "Restaurant-Biz", or "School Board"
...
Create a bulleted summary of all 20 stories, grouped by category. Each bullet includes:
1. Story headline
...
### Content Stats
- Total stories: 20
- Video scripts: [N] x 30s, [N] x 20s, [N] x 10s
- Estimated total recording time: [N] minutes
- Blog posts: 20 (~2400 words each)
- Reddit posts: 20
